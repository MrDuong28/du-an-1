...
<form action="" method="post" enctype="multipart/form-data" >
	<table width="990px" >
		<tr>
			<td colspan="2" ><b style="color:black;font-size:20px" >Thêm sản phẩm</b><br><br> </td>
			
		</tr>
		<tr>
			<td width="150px" >Tên : </td>
			<td width="840px">
				<input style="width:400px;margin-top:3px;margin-bottom:3px; border-radius: 5px;" name="ten" value="" >
			</td>
		</tr>
		<tr>
			<td>Danh mục : </td>
			<td>
				...
				?>
				<select name="danh_muc" style="margin-top:3px;margin-bottom:3px;border-radius: 5px" >
					<?php 
		...
		<tr>
			<td>Giá : </td>
			<td>
				<input style="width:400px;margin-top:3px;margin-bottom:3px;border-radius: 5px;" name="gia" value="" >
			</td>
		</tr>
		<tr>
			<td>Trang chủ : </td>
			<td>
				...
				?>
				<select name="trang_chu" style="margin-top:3px;margin-bottom:3px;border-radius: 5px" >
		...
		<tr>
			...
			<td>
				...
				?>
				<select name="noi_bat" style="margin-top:3px;margin-bottom:3px;border-radius: 5px" >
					<option value="" <?php echo $a_1; ?> >Không</option>
					<option value="co" <?php echo $a_2; ?> >Có</option>
				</select>
			</td>
		...
		<tr>
			...
			<td>
				<br>
				<input type="submit" name="bieu_mau_them_san_pham" value="Thêm" style="width:55px;height:30px;font-size:16px;border-radius: 5px" >
			</td>
		</tr>
	</table>
</form>