...
<form action="" method="post">
	<table width="990px" >
		<tr>
			<td width="180px" ><b style="color:black;font-size:20px" >Sửa menu dọc</b><br><br> </td>
		...
		<tr>
			...
			<td>
				<br>
				<input type="submit" name="bieu_mau_sua_menu_doc" value="Sửa" style="width:55px;height:30px;font-size:16px" >
			</td>
		</tr>
	</table>
</form>