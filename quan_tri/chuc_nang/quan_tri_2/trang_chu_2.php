...
<style type="text/css" >
	...
	a.lk_2:hover{color:blue;}
</style>
<table width="990px" >
	<tr>
		<td width="495px" valign="top" style=" border:1px solid black; text-align:center" >
	...
	<tr>
		<td valign="top" style=" border:1px solid black; text-align:center" >
